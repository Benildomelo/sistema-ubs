...
class UnitsManager {
    ...
    this.unidades = [
      {
        ...
        endereco: "Q. 26, SN - Parque Piaui, Teresina - PI, 64020-320",
        telefone: "86) 3215-7703",
      ...
      },
      {
        ...
        endereco:
          "R. Dióscoro Águiar, S/N - Porto do Centro, Teresina - PI, 64059-370",
        telefone: "(86) 3215-9201",
      ...
      {
        id: 3,
        nome: "UBS Porto Alegre",
        endereco: "R. R, 1 - Esplanada, Teresina - PI",
        telefone: "(86) 3215-9197",
        horarioFuncionamento: "Segunda a Sexta: 7h às 17h",
        distancia: "4.2 km",
        lat: -5.1156,
        lng: -42.7758,
      },
      {
        ...
        nome: "UBS Mocambinho",
        endereco:
          "Rua Coronel Ângelo Paz, 8130 Loteamento, R. Cel. Ângelo Paz, 8163 - Mocambinho, Teresina - PI, 64010-510",
        telefone: "(86) 3224-3691",
        horarioFuncionamento: "Segunda a Sexta: 7h às 17h | Sábado: 7h às 12h",
        distancia: "5.8 km",
        lat: -5.0572,
        lng: -42.7669,
      },
      {
        ...
        endereco:
          "Av. Duque de Caxias, 4696 - Buenos Aires, Teresina - PI, 64006-245",
        telefone: "(86) 3216-6271",
        horarioFuncionamento: "Segunda a Sexta: 7h às 17h",
        distancia: "1.8 km",
        lat: -5.0817,
        lng: -42.7894,
      },
      {
        ...
        nome: "UBS Poti Velho",
        endereco:
          "R. Mário Augusto Freitas, 1469 - Poti Velho, Teresina - PI, 64005-830",
        telefone: "(86) 3215-9170",
        horarioFuncionamento: "Segunda a Sexta: 7h às 17h",
        distancia: "3.2 km",
        lat: -5.0664,
        lng: -42.8111,
      },
      {
        ...
        endereco:
          "R. Raimundo Dorotéia, S/N - Santa Maria, Teresina - PI, 64012-450",
        telefone: "(86) 3215-9196",
        horarioFuncionamento: "Segunda a Sexta: 7h às 17h",
        distancia: "6.1 km",
        lat: -5.1233,
        lng: -42.7556,
      },
      {
        id: 8,
        nome: "UBS Parque Sul",
        endereco: "R. 5 - Esplanada, Teresina - PI",
      ...
      },
      {
        id: 9,
        nome: "UBS Gurupi",
        endereco: "R. Coração de Maria - Gurupi, Teresina - PI, 64091-010",
        telefone: "(86) 99438-5833",
        horarioFuncionamento: "Segunda a Sexta: 7h às 17h",
        distancia: "7.2 km",
        lat: -5.135,
        lng: -42.7889,
      },
      {
        id: 10,
        nome: "UBS Saci",
        endereco: "Q. Saci 63, 1-55 - Saci, Teresina - PI, 64020-200",
        telefone: "(86) 3215-9155",
        horarioFuncionamento: "Segunda a Sexta: 7h às 17h",
        distancia: "2.8 km",
        lat: -5.0711,
        lng: -42.7722,
      },
      {
        ...
        nome: "UBS Irma Dulce",
        endereco:
          "R. Santa Francisca Cabrine, S/N - Angelim, Teresina - PI, 64000-270",
        telefone: "86) 3219-3850",
        horarioFuncionamento: "Segunda a Sexta: 7h às 17h | Sábado: 7h às 12h",
        distancia: "1.5 km",
        lat: -5.0883,
        lng: -42.8,
      },
      {
        id: 12,
        nome: "UBS Promorar",
        endereco: "Av. Transversal 2 - Promorar, Teresina - PI, 64027-145",
        telefone: "(86) 3211-7396",
        horarioFuncionamento: "Segunda a Sexta: 7h às 17h",
        distancia: "5.3 km",
        lat: -5.1056,
        lng: -42.7333,
  ...
  goBackToDashboard() {
    ...
    const currentUser = JSON.parse(
      localStorage.getItem("ubs_current_user") || "{}"
    );
  ...
  filterUnits(searchTerm) {
    ...
    const filteredUnits = this.unidades.filter(
      (unidade) =>
